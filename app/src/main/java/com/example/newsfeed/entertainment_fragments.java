...
public class entertainment_fragments extends Fragment{

    String API_KEY = "d37e88d125a740c7837af6b3a51dd14a";
    ArrayList<ModelClass> modelClassArraylists;
    Adapter adapter;
    String country = "in";
    private RecyclerView recyclerViewoenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoenter = v.findViewById(R.id.entertainmentRecyclerView);
        modelClassArraylists = new ArrayList<>();
        recyclerViewoenter.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext() , modelClassArraylists );
        recyclerViewoenter.setAdapter(adapter);
